// CHANGES: replaced local Time.timeScale coroutine (ParryFreezeFrame) with
// HitStopManager.RequestHitStop, added AudioManager.Play("ParrySuccess").
...
public class PlayerInputActions : MonoBehaviour, IContract
{
    ...
    public void OnSuccessfulParry()
    {
        ...
        AudioManager.Play("ParrySuccess");
        HitStopManager.RequestHitStop(parryHitStopDuration);
    }
